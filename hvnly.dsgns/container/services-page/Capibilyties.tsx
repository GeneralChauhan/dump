    ...
    <div className="w-full bg-about padding-y rounded-t-[20px]">
      <div className="w-[82%] sm:w-full xm:w-full padding-x mb-[70px]">
        <h1 className="sub-heading font-medium font-NeueMontreal text-secondary">
          ...
          &nbsp;From building your website and designing your brand to launching
          marketing campaigns and managing your social media. You focus on
          running your business <span className="sm:hidden xm:hidden">—</span>
