...
// workiz page
export { default as Heroworkiz } from "./case-study-page/Hero";
export { default as Aboutworkiz } from "./case-study-page/About";
export { default as Works } from "./case-study-page/Works";
export { default as Challenge } from "./case-study-page/Challenge";
export { default as Result } from "./case-study-page/Result";
export { default as Credit } from "./case-study-page/Credit";
export { default as VideoWorkiz } from "./case-study-page/Video";
