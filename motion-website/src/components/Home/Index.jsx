...
import logo from '../../assets/images/8-dot-logo.svg';
        ...
        <div className='w-full sticky top-0 left-0 '>
            ...
            >
                <div className="w-full flex sm:flex items-center justify-between  ">
                    <div className="logo w-[6vh] h-[12vh] sm:w-[16vh] sm:h-[10vh] cursor-pointer z-[9] ">
                        {/* logo */}
                        <img src={logo} alt="logo" className='w-full h-full object-contain p-[60px]' />
                    </div>                   
