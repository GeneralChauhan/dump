  ...
  class q {
    constructor() {
      (this.travel = new X()),
        ...
        (this.ctx = this.canvas.getContext("2d")),
        (this.ctx.font = "600 96px Poppins"),
        ...
        this.orientation.matches
          ? (this.image.src = "photography--charlotte-gainsbourg.jpg")
          : (this.image.src = "photography--charlotte-gainsbourg.jpg"),
    ...
    draw() {
      this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height),
        ...
        (this.ctx.font = `600 ${this.progress.fontSize}vw Poppins`),
        (this.text = this.ctx.measureText("adventures")),
    ...
    onResize(t) {
      (this.viewport = t),
        ...
        this.destroyed ||
          (this.orientation.matches
            ? (this.image.src = "photography--charlotte-gainsbourg")
            : (this.image.src = "photography--charlotte-gainsbourg")),
        this.setImageDimensions(),
        (this.progress = {
